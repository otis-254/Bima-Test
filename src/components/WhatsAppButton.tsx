...
export function WhatsAppButton() {
  ...
  const handleWhatsAppClick = () => {
    // Use the full international format with '+' for api.whatsapp.com/send
    const phoneNumber = '+25414531574' 
    const message = 'Hello BIMA-AID Team,  I wish to secure your Assistance. What do I do?'
    // Use the api.whatsapp.com/send format which is more reliable
